...
* `main.ipynb` — Exploratory analysis, data transformation, and interactive visualization workflow.
* `requirements.txt` — Required Python packages for the project.

## 🛠️ Tech Stack & Libraries
* **Python 3**
* **Pandas & NumPy** — Data wrangling, cleansing, and geometric matrix operations.
* **Plotly** — Rendering interactive, hardware-accelerated 3D graphics and responsive UI elements.
...
4. **Open `main.ipynb`** in Jupyter Notebook or JupyterLab to explore the data processing and 3D visualization pipeline.
